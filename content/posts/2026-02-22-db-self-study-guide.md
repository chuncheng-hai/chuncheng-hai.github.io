...
description: "本文面向自学者梳理数据库学习的起点背景与常见误区，给出分阶段目标、资料选择、练习方式和复盘方法，帮助读者建立长期可执行的学习路径。"
...
基于问题意识，阅读《MySQL必知必会》  
掘金小册 的《MySQL 是怎样运行的：从根儿上理解 MySQL》  
极客时间的《MySQL实战45讲》  
刷题  
...
Course PostgreSQL for Everybody Specialization  
课程视频：[https://www.coursera.org/specializations/postgresql-for-everybody?#courses](https://www.coursera.org/specializations/postgresql-for-everybody?#courses)  
MongoDB  
Redis  
